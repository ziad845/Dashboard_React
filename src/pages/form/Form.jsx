...
import { Alert, Button, capitalize, MenuItem, Snackbar, Stack } from '@mui/material';
  ...
  return (
    ...
    >
      <Stack sx={{ gap: 2 }} direction={"row"}>
        <TextField
          error={Boolean(errors.firsrName)}


          helperText={Boolean(errors.firsrName) ? "This field is required & min 3 char" : null}


          {...register("firsrName", { required: true, minLength: 3 })}
          sx={{ flex: 1 }} label="First Name" variant="filled" />
        <TextField
          error={Boolean(errors.lastName)}


          helperText={Boolean(errors.lastName) ? "This field is required & min 3 char" : null}
